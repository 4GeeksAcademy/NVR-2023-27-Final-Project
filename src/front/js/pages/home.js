	...
	return (
		...
		>
			<>
				...
				<div className="modal border-0 fade" id="userModal" tabIndex="-1">
					<div className="modal-dialog border-0 rounded-0">
						<div className="modal-content rounded-o border-0">
							<div className="">
			...
			<>
				...
				<div className="modal fade border-0" id="providerModal" tabIndex="-1" aria-hidden="true">
					<div className="modal-dialog border-0 rounded-0">
						<div className="modal-content rounded-o border-0">
							<div className="">
							...
							<div className="modal-body border-0">
								<div className="form-group">
									<label className="loginLabel">email address</label>
									<input type="email" className="form-control  rounded-0 inputLoginModal" placeholder="Enter email" onChange={(e) => {
										setProviderEmail(e.target.value)
									}} />
								</div>
								<div className="form-group">
									<label className="loginLabel">Password</label>
									<input type="password" className="form-control  rounded-0 inputLoginModal" placeholder="Password" onChange={(e) => {
