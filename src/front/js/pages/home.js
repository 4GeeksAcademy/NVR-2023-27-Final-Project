		...
		>
			...
			<div className="Header pt-3 d-flex align-items-center justify-content-between">
				...
				<div className="buttons d-flex flex-row">
					...
					<span>
						<button className="registerUserButton me-3" onClick={handleClickRegisterUser}>register</button>
					</span>
				</div>
			</div>
			<div>
			...
			<div className="ms-5 mt-5 d-flex flex-row">
				...
				<div className="providerButtonsWrapper">
					...
					<span>
						<button className="providerHoemButton me-1" onClick={handleClickRegisterProvider}>provider register</button>
					</span>
				</div>
			</div>
