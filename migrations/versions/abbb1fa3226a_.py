...
Revision ID: abbb1fa3226a
Revises: 
Create Date: 2023-06-29 09:43:52.475515
...
def upgrade():
    ...
    sa.Column('service_description_id', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['provider_id'], ['provider_profile.id'], ),
    ...
    sa.Column('verbal_password', sa.String(length=50), nullable=True),
    sa.Column('qr_password', sa.String(length=50), nullable=True),
